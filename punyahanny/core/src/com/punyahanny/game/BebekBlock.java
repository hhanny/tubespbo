...
public class BebekBlock implements Screen{
    ...
    public void create(){
        ...
        floor = new BaseActor();
        floor.setTexture(new Texture(Gdx.files.internal("bg.png")));
        floor.setPosition(0, 0);
        mainStage.addActor(floor);

        cheese = new BaseActor();
        cheese.setTexture(new Texture(Gdx.files.internal("jagung.png")));
        cheese.setOrigin(cheese.getWidth()/3, cheese.getHeight()/3);
        cheese.setPosition(400,30);
        ...
        winText.setHeight(150);
        winText.setPosition(280,100);
...
//            mousey.velocityY -= SPEED;
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.M))
            game.setScreen( new BebekMenu(game) );
